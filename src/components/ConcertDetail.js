      ...
      teams: [
        {
          ...
          members: [
            { name: "김성주", role: "보컬", description: "경쾌한 보컬로 관객을 매료시키는 메인 보컬" },
          ...
          setlist: [
            { title: "한로로 - 비틀비틀 짝짜꿍", youtube: "https://youtu.be/XBiMV9kVhwQ?si=u8Z7HQs84tXzr0YK" },
            { title: "노브레인 - 넌 내게 반했어", youtube: "https://youtu.be/55dWF1PM8r4?si=7UW-Bi1ZTak7Ptye" },
            { title: "아이용 - 너는 록을 듣지 않아", youtube: "https://youtu.be/Bq0JS2uiduE?si=Hq9qaUQ_dJlKMo7V" },
            { title: "크라잉넛 - 밤이 깊었네", youtube: "https://youtu.be/VHNgusFusFQ?si=90QrXjz6WtvZmx-K" }
          ]
        },
        {
          id: 2,
